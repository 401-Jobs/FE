          ...
          <div class="sidebar-menu">
            <ul id="accordion-menu">
              ...
              <a href="#" class="dropdown-toggle no-arrow">
                ...
                <span class="mtext">Candidates</span>
              </a>
              ...
              <a href="#" class="dropdown-toggle no-arrow">
                ...
                <span class="mtext"> Shortlists</span>
              </a>

              <a href="#" class="dropdown-toggle no-arrow">
                <span class="micon dw dw-paint-brush"></span>
                <span class="mtext">Interviews</span>
              </a>
            </ul>
          </div>
        </div>
            ...
            <div class="row align-items-center">
              ...
              <div class="col-md-8">
                <h4 class="font-20 weight-500 mb-6 text-capitalize">
                  {/* company name */}
                  Welcome{" "}
                  <div class="weight-600 font-30 text-blue">company name!</div>
                </h4>
                <p class="font-18 max-width-600">
                  Good talent is getting harder to find and costing more to
                  attract. Find employees that rise to the occasion with job ads
                  that reflect your diverse company culture and values.
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="col-xl-8 mb-30">
              <div class="card-box height-100-p pd-20">
                ...
                <div id="chart5">
                  <img
                    src={hire}
                    style={{ "border-radius": "23px", width: "10%" }}
                  />
