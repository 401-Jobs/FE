                  ...
                  <MDBCardBody className='p-md-5 text-black text-center'>
                    ...
                    <MDBRow>
                      <MDBCol md='6' className='mb-4'>
                        <MDBInput type='text' size='lg' required label='First Name' />
                      </MDBCol>
                      <MDBCol md='6' className='mb-4'>
                        
                        <MDBInput type='text' size='lg' required label='Last Name'/>
                      </MDBCol>
                    {/* component  */}
                     <Country/> 
...
<MDBCol md='6' className='mb-4'>
                        ...
                        <MDBInput type='text' size='lg' label='Email' required/>
                      </MDBCol>      
                    ...
                    <MDBInput type='text' className='mb-4' size='lg'label='Company Name'  required/>
        
                    <MDBInput type='text' className='mb-4' size='lg' label='Company Website'/>
            
                    <MDBInput type='text' className='mb-4' size='lg' label='Company Address' required />
