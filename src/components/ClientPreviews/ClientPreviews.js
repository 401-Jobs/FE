...
const ClientPreviews = () => {
    ...
    linkedin,
    github,
    porto, jobseekerData} = useContext(JoobSeekerContext);
    ...
    setRandomUserEducation(res.data["userEducation"].filter(ele=>{
        return owner==ele["owner"]
       }))
       setRandomUserWork(res.data["userWork"].filter(ele=>{
        return owner==ele["owner"]
       }))
    ...
    <div className='main_container'>
        ...
        <hr/>
            ...
            <div className='left_section'>
                ...
                <hr/>
                <Media linkedin={randomUserDetails["linkedin"]} github={randomUserDetails["github"]} porto={randomUserDetails["porto"]}/>
        </div>
    </div>
            </div>
        )
